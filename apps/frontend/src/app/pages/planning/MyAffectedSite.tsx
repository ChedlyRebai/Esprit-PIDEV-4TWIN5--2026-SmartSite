import { fetchSites,fetchMyAffectedSites } from "@/app/action/site.action";
...
const MyAffectedSite = () => {
  const [sites, setSites] = useState<Site[]>([]);

  const { data, isPending, isLoading, isError } = useQuery({
    queryKey: ["MyAffectedSitesData"],
    queryFn: async () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">My Affected Sites</h1>
