...
import { createSupplier, getSupplierCategories, Supplier } from "@/app/action/supplier.action";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.status === 201 || res.status === 200) {
        ...
        toast.error(res.data || "Failed to create supplier");
      }
    } catch (error) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Create a new supplier for your projects
            </p>
          </div>
        </div>
      </div>
