      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            {t(
              "supplierMaterials.supplierMaterialListTitle",
              "Supplier Material List",
            )}
          </h1>
          <p className="text-gray-500 mt-1">
            {t(
              "supplierMaterials.supplierMaterialListSubtitle",
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t("supplierMaterials.selectSupplier", "Select Supplier")}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex gap-4 mb-4">
            <Select value={selectedSupplier} onValueChange={handleSupplierChange}>
              <SelectTrigger className="w-[300px]">
                <SelectValue
                  placeholder={t(
                    "supplierMaterials.selectSupplierPlaceholder",
                    "Select a supplier...",
                  )}
                />
              </SelectTrigger>
            ...
            {selectedSupplier && (
              <Button variant="outline" onClick={() => navigate(`/suppliers/${selectedSupplier}`)}>
                {t(
                  "supplierMaterials.viewSupplierProfile",
            ...
            <>
              <div className="flex gap-4 mb-4">
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <Input
                      placeholder={t(
                        "supplierMaterials.searchMaterialsPlaceholder",
                        "Search materials...",
                      )}
                      className="pl-10"
                      value={search}
              ...
              {loading ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  {t(
                    "supplierMaterials.noMaterialsFound",
                    ...
                    <thead>
                      <tr className="border-b">
                        <th className="text-left py-3 px-4 font-medium">
                          {t(
                            "supplierMaterials.table.material",
                            "Material",
                          )}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t(
                            "supplierMaterials.table.category",
                            "Category",
                          )}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t("supplierMaterials.table.price", "Price")}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t(
                            "supplierMaterials.table.delivery",
                            "Delivery",
                          )}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t(
                            "supplierMaterials.table.availability",
                            "Availability",
                          )}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t(
                            "supplierMaterials.table.preferred",
                            "Preferred",
                          )}
                        </th>
                        <th className="text-left py-3 px-4 font-medium">
                          {t("supplierMaterials.table.actions", "Actions")}
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {filteredMaterials.map((item) => (
                        <tr key={item._id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            ...
                            >
                              {t("supplierMaterials.details", "Details")}
                            </Button>
                          </td>
                        </tr>
                      ))}
